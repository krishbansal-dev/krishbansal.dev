...
const academics = [
  {
    ...
    details: 'Pre-Final Year. Active member of the Programming and Algorithms Group. Focusing on data structures, advanced algorithms, and systems engineering.',
    status: 'IN PROGRESS',
    icon: 'school',
  },
  {
    ...
    details: 'Non-Medical stream (Physics, Chemistry, Mathematics). Rigorous preparation in core sciences, analytical reasoning, and competitive mathematics.',
    status: 'COMPLETED',
    icon: 'history_edu',
  },
  {
    ...
    details: 'Foundation years. Developed early aptitude for logic, programming fundamentals, mathematics, and public speaking.',
    status: 'COMPLETED',
    icon: 'local_library',
  },
]
